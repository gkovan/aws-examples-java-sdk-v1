...
public class DynamoDBMapperTransactionExample {
    ...
    /*
     * To run this example, create two DynamoDB tables:
     * 1) Table name: Thread, Partition key: ForumName , Sort key: Subject
     * 2) Table name: Forum, Partition key: Name
     * 
     * You need to be logged in to the AWS account with the AWS DynamoDB resources already created.
     */
